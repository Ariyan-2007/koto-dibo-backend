...
public static class HouseholdRolePolicy
{
    private static readonly IReadOnlyDictionary<HouseholdRole, HouseholdPermission[]> Permissions = new Dictionary<HouseholdRole, HouseholdPermission[]>
    {
        ...
        [
            ...
            HouseholdPermission.AddContribution, HouseholdPermission.AddAnyContribution, HouseholdPermission.ViewContributions,
            HouseholdPermission.UpdateContribution, HouseholdPermission.DeleteContribution,
            HouseholdPermission.AddWithdrawal, HouseholdPermission.AddAnyWithdrawal, HouseholdPermission.ViewWithdrawals,
            HouseholdPermission.DeleteWithdrawal,
            HouseholdPermission.ViewHouseholdBalance,
        ...
        [
            ...
            HouseholdPermission.AddWithdrawal, HouseholdPermission.ViewWithdrawals,
            HouseholdPermission.ViewHouseholdBalance,
        ...
        [
            ...
            HouseholdPermission.ViewWithdrawals,
            HouseholdPermission.ViewHouseholdBalance,
